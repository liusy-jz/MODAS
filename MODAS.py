...
if __name__ == "__main__":
    ...
    parser_prescreen.add_argument('-lmm_suggest_pvalue', default=1e-6, type=float, metavar='[default:1e-6]', help=' LMM suggest pvalue for phenotype prescreen, used to obtain candidate phenotypes with significant association analysis signals and significant association regions of phenotypes, default 1e-6')
